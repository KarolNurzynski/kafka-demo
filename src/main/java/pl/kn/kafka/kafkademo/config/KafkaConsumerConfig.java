package pl.kn.kafka.kafkademo.config;
...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, TransactionData> consumerFactory() {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, TransactionData> kafkaListenerContainerFactory() {
